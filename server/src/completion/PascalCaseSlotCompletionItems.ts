...
export class PascalCaseSlotCompletionItems implements CompletionItemProvider<CompletionItem> {
  ...
  getSlotsCompletionItems(tag: string): CompletionItem[] {
    ...
    const snakeTag = pascalToSnakeCase(tag)
    const attributes: DocumentSlot[] = document['n-' + snakeTag].slots || []
