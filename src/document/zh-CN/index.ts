...
import nbreadcrumbitem from './n-breadcrumb-item'
...
import ndatatablecolumn from './n-data-table-column'
import ndatepicker from './n-date-picker'
import ndaterange from './n-date-range'
import ndatetimerange from './n-date-time-range'
import ndatetime from './n-date-time'
import ndate from './n-date'
import ndescriptions from './n-descriptions'
import ndescriptionitem from './n-description-item'
...
import nformitemgi from './n-form-item-gi'
import ngradienttext from './n-gradient-text'
import ngrid from './n-grid'
import ngriditem from './n-grid-item'
...
import nmonthrange from './n-month-range'
import nmonth from './n-month'
...
import nquarterrange from './n-quarter-range'
...
import ntimelineitem from './n-timeline-item'
...
import nweek from './n-week'
import nyearrange from './n-year-range'
import nyear from './n-year'
...
export default {
  ...
  'n-data-table-column': ndatatablecolumn,
  'n-date-picker': ndatepicker,
  'n-date-range': ndaterange,
  'n-date-time-range': ndatetimerange,
  'n-date-time': ndatetime,
  'n-date': ndate,
  'n-descriptions': ndescriptions,
  'n-description-item': ndescriptionitem,
  'n-dialog': ndialog,
  'n-divider': ndivider,
  'n-drawer': ndrawer,
